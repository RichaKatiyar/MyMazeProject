...
public final class MazeImpl implements Maze {
	...
	public final String[] mazeData;

    public final int dimensionX;

    public final int dimensionY;

    public final long numberOfWalls;
    public final long numberOfEmptySpaces;

    public MazeCoordinate startLocation;

    public final MazeCoordinate exitLocation;

    public final String LINEBREAK = "\\r?\\n";
