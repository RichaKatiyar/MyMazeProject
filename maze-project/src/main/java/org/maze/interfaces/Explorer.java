...
public interface Explorer {
    ...
    /**
     * Move forward based on the current position's coordinate and heading direction
     */
    void moveForward();
     ...
     *
     * @param times the number of fields the explorer needs to move forward
     */
    ...
    /**
     * set heading direction to 90 degrees anti clockwise
     * e.g. UP becomes LEFT
     */
    void turnLeft();

    /**
     * set heading direction to 90 degrees clockwise
     * e.g. UP becomes RIGHT
     */
    void turnRight();
     ...
     *
     * @return the current position of the explorer including coordinate and heading direction
     */
     ...
     *
     */
    void setPosition(ExplorerPosition position);
