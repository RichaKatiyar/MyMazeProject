package org.maze.position;

import org.maze.exception.FieldIsOutOfMazeBoundsException;
...
public class ExplorerPosition {
	...
	public final HeadingDirectionClockWise direction;
    ...
    public void setCoordinate(MazeCoordinate coordinate) {
